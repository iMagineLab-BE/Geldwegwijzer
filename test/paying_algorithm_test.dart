...
void main() {
  group('Paying Algorithm', () {
    ...
    test('Test 2 - not exact amount', () {
      ...
      expect(splitMoney[describeEnum(Coin.n1Euro)], 2); // ideal: 0
      expect(splitMoney[describeEnum(Coin.n2Euro)], 2); // ideal: 3

      expect(moneyInPocket[describeEnum(Coin.n1Euro)], 1); // ideal: 3
      expect(moneyInPocket[describeEnum(Coin.n2Euro)], 1); // ideal: 0
    });
    ...
    test('Test 4 - not exact amount', () {
      ...
      expect(splitMoney[describeEnum(Coin.n2Euro)], 1); // ideal: 0
      expect(splitMoney[describeEnum(Coin.n5Euro)], 1); // ideal: 0
      expect(splitMoney[describeEnum(Coin.n100Euro)], 2); // ideal: 2

      expect(moneyInPocket[describeEnum(Coin.n2Euro)], 0); // ideal: 1
      expect(moneyInPocket[describeEnum(Coin.n5Euro)], 0); // ideal: 1
      expect(moneyInPocket[describeEnum(Coin.n100Euro)], 0); // ideal: 0
    });
  });
}
